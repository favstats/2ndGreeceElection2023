...
election_title <- "2nd 2023 Greek legislative election"
the_country <- "Greece"
  ...
  div(
    ...
    div(
      ...
      div(  # Wrapped the image in another div to center it horizontally
        ...
        img(
          class = "card-img", 
          src = "https://github.com/favstats/GreeceElection2023/blob/main/img/5frKLhQ0.png?raw=true",
          style = "max-width: 500px;"  # Adjusted max-width to control image size
        )
      )
    ),
    div(
      ...
      div(
        ...
        p(
          class = "card-text", 
          "Alexandros Gotinakos is a predoctoral researcher for the ActEU project at Aristotle University of Thessaloniki. Interested in comparative political behavior, political psychology, and survey methodology.
...
+ `r emo::ji("greece")` [2nd 2023 Greek Legislative election](https://favstats.github.io/BremenStateElection2023/) (25 May 2023)
